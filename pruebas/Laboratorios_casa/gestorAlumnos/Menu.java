...
public class Menu {
	...
	public void eliminarIscripcion() {
		...
		if (auxelimAlum == true && auxelimMat == true) {
			System.out.println("Alumno :" + nombreAlum + " " + apellidoAlum + " Eliminado de la inscripción a materia: "
					+ nombreMat);
		}
	...
	public void buscarIscripcion() {
		...
		if (auxBusAlum == true && auxBusMat == true) {
			System.out.println("Buscando los datos del alumno :" + nombreAlum + " " + apellidoAlum + " y de materia: "
					+ nombreMat);
